...
var events_desc = {
	EVENT.SAT_COL : ["Satellite collision",
					"Chief, we have detected a collision between two satellites in low Earth orbit. Debris is minimal, but it may pose a potential risk to our active communication satellites.",
					"Choice1",
					"Choice2"
					],
	EVENT.MIN_AST : ["Minor asteroid",
					"Chief, an asteroid the size of a small building will pass within the Moon’s orbit in 36 hours. Its presence does not pose a direct threat, but its proximity does warrant monitoring.",
					"Choice1",
					"Choice2"
					],
	EVENT.SOL_FLAR : ["Solar flare",
					"Chief, a solar flare has erupted and is the cause of several minor disruptions to our communication networks.",
					"Choice1",
					"Choice2"
					],
	EVENT.LARG_AST : ["Large asteroid detected",
					"Chief, our deep-space telescopes have identified a large asteroid on a potential collision course with Earth. Impact probability is at 42%, with a margin for error.",
					"Choice1",
					"Choice2"
					],
	EVENT.SOL_STORM : ["Solar storm",
					"Chief, a significant solar storm is currently impacting our geomagnetic field. Power grids are currently destabilizing across the city.",
					"Choice1",
					"Choice2"
					],
